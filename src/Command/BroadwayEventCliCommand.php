...
class BroadwayEventCliCommand extends GeneratorCommand
{
    ...
    {
        $this->setName('gnerate:broadway:event')
    ...
    protected function interact(InputInterface $input, OutputInterface $output)
    {
        ...
        if (true === empty($input->getOption('className'))) {
            $questionHelper->writeSection($output, 'Generate Broadway event');
            ...
            while (true) {
                $question = new Question($questionHelper->getQuestion('Enter Broadway event class name', ''));
